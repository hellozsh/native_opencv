...
// typedef _adjust_brightness_contrast_func = ffi.Void Function(ffi.Pointer<Utf8>, ffi.Pointer<Utf8>); // ffi.Double, ffi.Double
typedef _draw_lines_add_chromosomes_func = ffi.Void Function(ffi.Pointer<Utf8>, ffi.Pointer<Utf8>, ffi.Pointer<MyStruct>, ffi.Int8); //
...
typedef _drawLinesAddChromosomesFunc = void Function(ffi.Pointer<Utf8>, ffi.Pointer<Utf8>, ffi.Pointer<MyStruct>, int);
